...
export class ExerciseController {
  ...
  @Get()
  @ApiOperation({
    summary: "List exercises with pagination, search, and filters",
  })
  ...
  async getExercises(
    ...
    return exercises.map((exercise) => ({
      ...
      instructions:
        exercise.instructions === null ? undefined : exercise.instructions,
      isCustom: exercise.isCustom,
      createdBy: exercise.createdBy === null ? undefined : exercise.createdBy,
      parentVariationId:
        exercise.parentVariationId === null
          ? undefined
          : exercise.parentVariationId,
      tags: exercise.tags,
  ...
  async getExerciseById(@Param("id") id: string): Promise<ExerciseResponseDto> {
    ...
    return {
      ...
      updatedAt: exercise.updatedAt,
      muscleGroups:
        exercise.muscleGroups === null ? undefined : exercise.muscleGroups,
      equipmentNeeded:
