...
export class WorkoutSessionsController {
  ...
  @UseGuards(JwtAuthGuard)
  @ApiOperation({
    summary: "Get user sessions with filtering, pagination, and sorting",
  })
  ...
  @ApiResponse({
    status: 200,
    description: "Return the active session or null",
  })
  @ApiResponse({ status: 401, description: "Unauthorized" })
  @ApiResponse({ status: 500, description: "Internal server error" })
  @ApiBearerAuth()
  ...
  @ApiResponse({
    status: 200,
    description: "Return a list of historical sessions",
  })
  @ApiResponse({ status: 401, description: "Unauthorized" })
  @ApiResponse({ status: 500, description: "Internal server error" })
  @ApiBearerAuth()
