...
export class WorkoutController {
  ...
  async getWorkouts(@Req() req: Request): Promise<WorkoutResponseDto[]> {
    ...
    return workouts.map((workout) => ({
      ...
      name: workout.name,
      description:
        workout.description === null ? undefined : workout.description,
  ...
  async getWorkoutById(
    ...
    const userId = user.id;
    const workoutWithExercises = (await this.workoutService.findOne(
      id,
      userId,
    )) as any;
    // Map to response DTO
    return {
      ...
      description:
        workoutWithExercises.description === null
          ? undefined
          : workoutWithExercises.description,
      createdAt: workoutWithExercises.createdAt,
      updatedAt: workoutWithExercises.updatedAt,
      deletedAt:
        workoutWithExercises.deletedAt === null
          ? undefined
          : workoutWithExercises.deletedAt,
  ...
  async createWorkout(
    ...
    const userId = user.id;
    const workoutWithExercises = (await this.workoutService.create(
      userId,
      createWorkoutDto,
    )) as any;
    // Map to response DTO
  ...
  async updateWorkout(
    ...
    const userId = user.id;
    const workoutWithExercises = (await this.workoutService.update(
      id,
      userId,
      updateWorkoutDto,
    )) as any;
