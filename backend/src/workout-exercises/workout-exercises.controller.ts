...
export class WorkoutExercisesController {
  ...
  @ApiResponse({
    status: 200,
    description: "Return a list of workout exercises",
  })
  @ApiResponse({ status: 401, description: "Unauthorized" })
  ...
  async updateWorkoutExercise(
    ...
    const workoutExercise =
      await this.workoutExercisesService.updateWorkoutExercise(
        workoutId,
        userId,
        workoutExerciseId,
        dto,
    ...
    const exercise = await this.workoutExercisesService[
      "exerciseService"
  ...
  async deleteWorkoutExercise(
    ...
    const userId = user.id;
    await this.workoutExercisesService.deleteWorkoutExercise(
      workoutId,
      userId,
      workoutExerciseId,
    );
  ...
  @ApiResponse({
    status: 200,
    description: "Workout exercises reordered successfully",
  })
  @ApiResponse({ status: 400, description: "Bad request" })
  @ApiResponse({ status: 401, description: "Unauthorized" })
  @ApiResponse({ status: 404, description: "Workout not found" })
  ...
  async reorderWorkoutExercises(
    ...
    const userId = user.id;
    await this.workoutExercisesService.reorderWorkoutExercises(
      workoutId,
      userId,
      dto,
    );
